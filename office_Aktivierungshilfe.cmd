...
cls
color 07
title  Office Aktivierungsassistent %masver%
...
goto :oh_menu2   ← automatische Weiterleitung zu Option 1
...
echo:
echo                 [1] Online Aktivierung Ihrer Office 2024 Suite
echo                 ____________________________________________

echo                 [0] %_exitmsg%
echo         ____________________________________________________________
echo: 
call :dk_color2 %_White% "             " %_Green% "Geben Sie eine der Zahlen ueber Ihr Keyboard ein  [1,0]"
choice /C:1230 /N
set _el=!errorlevel!
if !_el!==4  exit /b
...
echo Initiiere diagnostische Tests...
...
echo:
echo Office wird fuer die Aktivierung vorbereitet...                    [C2R ^| %_version% %_AudienceData%^| %_oArch%]
...
call :dk_color %Green% "Office wurde erfolgreich aktiviert."
if defined ohub call :dk_color %Gray% "Sie koennen Office nun benutzen"
echo.
) else (
...
echo:
echo Aktivierungsvorgang:...................[Erfolgreich]
if defined exhook (
echo Weitere Anpassungen:...................[Erfolgreich]
) else (
echo.
)
...
echo:
echo V Office...                    [MSI ^| %_version% ^| %_oArch%]
...
echo Ueberpruefe Kompatibilitaet Betriebssystem                        [%winos% ^| %fullbuild% ^| %osarch%]
exit /b
...
if defined generickey (set "keyecho=Ihr Produktschluessel wird hinterlegt und aktiviert...........") else (set "keyecho=Installing Product Key                 ")
if %keyerror% EQU 0 (
if %sps%==SoftwareLicensingService call :dk_refresh
echo %keyecho% [Erfolgreich]
) else (
call :dk_color %Red% "%keyecho% [Failed] %keyerror%"
if not defined error (
...
call :dk_color %_Yellow% "Druecken Sie eine beliebige Taste zum %_exitmsg%..."
pause %nul1%
)
